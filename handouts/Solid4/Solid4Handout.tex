...
Set up all six orders of integration for \[\iiint\limits_{R_4} f(x,y,z) \, dV,\] where $R_4$ is the region bounded by 
\[x+y+z=1,\ x=0,\ y=0,\ \text{and } z=0.\]
...
\vspace{-1em}
	\centering
	\begin{tabular}{ll}
		\includegraphics[width=.3\textwidth]{Solid4Full} &
		\includegraphics[width=.45\textwidth]{Solid4Print}
	\end{tabular}
	\caption{Computer-modeled and 3D-printed views of $R_4$}
\end{figure}
...
\vspace{-1em}
	\centering
	\begin{tabular}{ccc}
		\subfloat[$xy$-projection.]{\includegraphics[width=.3\textwidth]{Solid4XYProj}} &
		\subfloat[$xz$-projection.]{\includegraphics[width=.3\textwidth]{Solid4XZProj.pdf}} &
		\subfloat[$yz$-projection.]{\includegraphics[width=.3\textwidth]{Solid4YZProj.pdf}}
	\end{tabular}
	\caption{Projections of $R_4$ into the three coordinate planes.}%\label{projE2}
\end{figure}
...
\[\int_{0}^{1}\int_{0}^{1-y}\int_{0}^{1-x-y} f(x,y,z) \,dz \,dx \,dy\]
...
\[\int_{0}^{1}\int_{0}^{1-z}\int_{0}^{1-x-z} f(x,y,z) \,dy \,dx \,dz \]
\[\int_{0}^{1}\int_{0}^{1-x}\int_{0}^{1-x-z} f(x,y,z) \,dy \,dz \,dx \]

The following triple integrals represent integrating over the region using the $yz$-projection:

\[\int_{0}^{1}\int_{0}^{1-z}\int_{0}^{1-y-z} f(x,y,z) \,dx \,dy \,dz\]
\[\int_{0}^{1}\int_{0}^{1-y}\int_{0}^{1-y-z} f(x,y,z) \,dx \,dz \,dy\]

\vspace{1em}
All of these triple integrals evaluate to $\frac{1}{6}$ when $f(x,y,z) = 1$.
